class Boardclass:
    ...
    def printStats(self)-> None:
        ...
        """
        return f"players user name: {self.getname()}\nuser name of the last person to make a move:{self.getlast_player_name()}\nnumber of games:{self.updateGamesPlayed()}\nnumber of wins: {self.getwins()}\nnumber of losses: {self.getlosses()}\nnumber of ties: {self.getties()}"
